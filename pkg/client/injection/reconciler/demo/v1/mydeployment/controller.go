...
import (
	...
	mydeployment "knative.dev/sample-controller/pkg/client/injection/informers/demo/v1/mydeployment"
)

const (
	defaultControllerAgentName = "mydeployment-controller"
	defaultFinalizerName       = "mydeployments.samples.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	mydeploymentInformer := mydeployment.Get(ctx)

	lister := mydeploymentInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "samples.knative.dev.MyDeployment"),
	)
