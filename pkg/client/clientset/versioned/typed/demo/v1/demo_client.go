...
// SamplesV1Client is used to interact with features provided by the samples.knative.dev group.
type SamplesV1Client struct {
	restClient rest.Interface
}

func (c *SamplesV1Client) MyDeployments(namespace string) MyDeploymentInterface {
	return newMyDeployments(c, namespace)
}
